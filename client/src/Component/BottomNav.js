        ...
        return (
            <div>
                <Footer 
                    ...
                    className='example'
                >
                    <h5 className="white-text"><i>Viztory:</i> Visual House Price</h5>
                    <p id="data" className="grey-text text-lighten-4">Data based on House Price Index (HPI): a weighted, repeat-sales index, measuring average price changes in repeat sales or refinancings on the same single-family houses in the United States.</p>
                </Footer>
            </div>
        );
    }
